//  Copyright (c) 2014 Geoffrey Kruse
//  Copyright (c) 2018 Sebastian Boehm (BTU-CS) 
//	- Adapted to Version 2.18.1 PSD file format
//	- Added input/output file arguments
...
int main(int argc, const char * argv[])
{
	if (argc != 3)
	{
		printf("exactly two arguments required: an input and an output file\n");
		return 1;
	}
    ...
    dumper = pcap_dump_open(pcap_dumpfile, argv[2]);
    ...
    do
    {
        ...
        if(bytesRead)
        {
            // TI 64 bit counter value divided by clock speed
            packetData.timeStamp /= 32;
